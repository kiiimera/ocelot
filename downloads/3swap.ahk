...
Gui Add, Hotkey, x85 y27 w75 h25 vSwapbind BackgroundTrans, %Swapbind%
...
UpdateHotkeys:
	...
	SaveData(bind1, coord1x, coord1y, coord2x, coord2y, coord3x, coord3y)
...
SaveData(bind1, coord1x, coord1y, coord2x, coord2y, coord3x, coord3y) {
	filePath := A_ScriptDir "\g3data.txt"
	FileDelete, %filePath%
	FileAppend, %bind1%`n%coord1x%`n%coord1y%`n%coord2x%`n%coord2y%`n%coord3x%`n%coord3y%, %filePath%
}
